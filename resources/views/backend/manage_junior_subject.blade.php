...
<main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Manage Junior Subjects</h1>
                                @if ($errors->any())
                                                ...
                                                <tbody>
                                                    @foreach($subjectData as $key => $subjectDatas)
                                                            ...
                                                            <td><a href="" data-bs-toggle="modal" data-bs-target="#exampleModal3{{$subjectDatas->id}}"><i class="fas fa-edit"></i></a>&nbsp;
                                                                ...
                                                                <form id="delete-form-{{$subjectDatas->id}}"  action="{{route('junior_subject.destroy',$subjectDatas->id)}}" id="delete-form{{$subjectDatas->id}}" method="POST">
                                                                    @csrf
                                                                    @method('DELETE')
                                                                </form>
