                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    @foreach($teacher as $key => $teachers)
                                                            ...
                                                            <td>{{$teachers->role}}</td>
                                                            <td><button href="" data-bs-toggle="modal" data-bs-target="#exampleModal3{{$teachers->id}}"><i class="fas fa-eye text-primary"></i> view</button>&nbsp;

                                                            <div class="modal fade" id="exampleModal3{{$teachers->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                    <div class="modal-dialog">
                                                                        ...
                                                                        <div class="row">
                                                                                <div class="col-md-6">
                                                                                    <h6>IMAGE</h6>
                                                                                    <img src="{{url('upload/teacherphoto/'.$teachers->image)}}" width="450px" height ="350px" alt="">
                                                                                </div>
                                                                            </div>
                                                                        </div>
